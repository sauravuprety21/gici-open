...
const std::map<ErrorType, std::string> kErrorToStr{
    ...
    {ErrorType::kRelativePositionAndVelocityError,
     std::string("RelativePositionAndVelocityError")},
    ...
    {ErrorType::kRelativeTroposphereError,
     std::string("RelativeTroposphereError")},
    {ErrorType::kRelativeIonosphereError,
     std::string("RelativeIonosphereError")},
};
}
