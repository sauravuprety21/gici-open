/**
 * @Function: Multiple pseudorange residuals block.
 *
...
// Group 3: Group 1 + P3. IFB, P4. troposphere delay (1), P5. ionosphere delay
// (1) Group 4: Group 2 + P4. IFB, P5. troposphere delay (1), P6. ionosphere
// delay (1)
template <int... Ns>
class MultiPseudorangesError : public ceres::CostFunction,
...
public:
  ...
  MultiPseudorangesError();

  /// \brief Construct with measurement and information matrix
  /// @param[in] measurement The measurement at rover.
  /// @param[in] error_parameter To compute GNSS information matrix.
  MultiPseudorangesError(const GnssMeasurement &measurement,
                         const GnssMeasurementsIndexes &indexes,
                         const GnssErrorParameter &error_parameter);

  /// \brief Trivial destructor.
  virtual ~MultiPseudorangesError() {}
  ...
  virtual ErrorType typeInfo() const {
    return ErrorType::kMultiPseudorangesError;
  }
...
protected:
  ...
  GnssMeasurementsIndexes indexes_;
  ...
  char system_;
  bool correct_ifcb_ = false;
};

// Explicitly instantiate template classes
template class MultiPseudorangesError<3, 1>;    // Group 1
template class MultiPseudorangesError<7, 3, 1>; // Group 2
