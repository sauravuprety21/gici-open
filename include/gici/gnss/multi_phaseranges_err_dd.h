/**
 * @Function: Multiple double-differenced phaseranges residuals block.
...
template <int... Ns>
class MultiPhaserangesErrorDD : public ceres::CostFunction,
...
public:
  ...
  MultiPhaserangesErrorDD(const GnssMeasurement &measurement_rov,
  ...
  virtual ~MultiPhaserangesErrorDD() {}
...
template class MultiPhaserangesErrorDD<3, 1>;    // Group 1
template class MultiPhaserangesErrorDD<7, 3, 1>; // Group 2
